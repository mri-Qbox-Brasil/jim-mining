Config.Locations = {
    ...
    ["Mines"] = {
        ...
        ["K4MB1"] = { -- K4MB1's Mineshaft in the quarry
            ...
            Cracking = {
                { name = "Quebrar Pedras", coords = vec4(2914.9, 2650.78, 43.08, 231.77), sprite = 566, col = 81, blipTrue = false, prop = `prop_vertdrill_01` }, -- Fundição
                { name = "Quebrar Pedras", coords = vec4(2914.61, 2649.06, 43.19, 272.74), sprite = 566, col = 81, blipTrue = false, prop = `prop_vertdrill_01` }, -- Fundição
            },
            OreBuyer = {
                { blipEnable = true, name = "Comprador de Minérios", coords = vec4(2917.79, 2646.26, 43.17, 6.14), sprite = 568, col = 81,model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD", },
            },
            JewelCut = {
                { blipEnable = true, name = "Lapidar Jóias", coords = vec4(2917.45, 2654.24, 43.03, 229.61), sprite = 566, col = 81, prop = `gr_prop_gr_speeddrill_01c` },
                { blipEnable = true, name = "Lapidar Jóias", coords = vec4(2919.89, 2656.36, 43.15, 199.99), sprite = 566, col = 81, prop = `gr_prop_gr_speeddrill_01c` },
            },
            OrePositions = {
